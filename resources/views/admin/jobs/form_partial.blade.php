...
<div class ="form-group">
  <fieldset class="form-group" id="title_fieldset">
    {!!  Form::label('deadline', trans('admin.deadline'), array('class' => '')) !!}
    <div class ="">
      {!!  Form::date('deadline' ,old('deadline'), array('class'=>'form-control') ) !!}
    </div>
  </fieldset>
</div>
...
<div class ="form-group">
  <fieldset class="form-group" id="title_fieldset">
    {!!  Form::label('duration', trans('admin.duration'), array('class' => '')) !!}
    <div class ="">
