    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="btn-group" role="group" aria-label="...">
                ...
                <a href="/admin/controlpanel" class="btn btn-default">{!! trans("admin.controlpanel") !!}</a>
                <a href="/" class="btn btn-default">{!! trans("admin.website") !!}</a>
                <a href="/logout" class="btn btn-default">{!! trans("admin.logout") !!}</a>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $('#save , #draft, #delete').click(function(event) {
            ...
            if (typeof tinyMCE != "undefined") {
                ...
                @if( starts_with(Route::currentRouteName() , 'products'))
