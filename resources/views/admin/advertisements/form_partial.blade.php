...
<div class ="form-group">
  <fieldset class="form-group" id="area_fieldset">
    {!!  Form::label('area', trans('admin.area'), array('class' => '')) !!}
    <div>
      {!!  Form::text('area' ,old('area'), array("disabled"=>"disabled", 'class'=>'form-control') ) !!}
    </div>
  </fieldset>
</div>
