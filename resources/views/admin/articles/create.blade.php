...
@section('content')
  ...
  @section('title',  trans('admin.create').' '.trans('admin.article') )
  @section('PageHeading',  trans('admin.create').' '.trans('admin.article') )
...
<div class="article_writer_result" id="article_writer_result" style="">
  ...
  {!! Form::open(array('url' => '/admin/articles/' , 'class'=>'' , 'id'=>'myform' , 'name'=>'myform')) !!}
  <div class="">
