...
{!! MetaTags( $job->title." | ".settings("websiteName"), $job->title, $job->getImage() , $job->image, settings("websiteName") ) !!}
    {{--<div class="row">--}}
        {{--<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">--}}
            {{--<h2 class="mainTitle" >{!! $job->title !!}</h2>--}}
        {{--</div>--}}
        {{--<div class="clearfix"></div>--}}
    {{--</div>--}}
    {{--<div class="panel panel-default">--}}
        {{--<div class="ads_img col-sm-6 col-sm-push-6">--}}
            {{--<img class="img-responsive  child" src="{!! PhotosDir($job->getImage()) !!}" alt="{{$job->title}}">--}}
        {{--</div>--}}
    ...
    <div class="">
        <h2 id="mainTitle" class="mainTitle">{!! RemoveEntity($job->title) !!}</h2>
        @if($closed == true)
            <div style="
    ...
    <div class="row" style="position: relative;margin-bottom: 20px;margin-left: 10px;">
        <div class="col-sm-8">
            {!!   Html::image(PhotosDir($job->getImage(), true, [1150,700]) ,  $job->title  , array('width'=>'100%','height'=>'500', 'class' => 'img-responsive full_width_image')) !!}
        </div>
    </div>
    ...
    <div style="
        ...
        <img style="display: inline-block; " src="{!! 	ThemeHelper() !!}img/logo.png" width="60px"
             alt="{!! Settings::get('websiteName')  !!}"> <span
                style="display: inline-block; color: #403D91; margin-right: 10px;"> {!! $job->source !!} </span>
    </div>
