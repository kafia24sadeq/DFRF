...
<div class="container">
    ...
    src="{!! ThemeHelper() !!}/img/icons/logo.png"></a>
    </a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav " >
      <li class="nav-item "><a href="{{ '/' }}" class="nav-link  nav-color  @if ( Request::is('/*'))active
          
      @endif"  >{!!
                  trans("public.home") !!}</a></li>
      <li class="nav-item ">
          <a  href="{{ '/pages/1' }}"   class="nav-link nav-color @if(\Request::is('pages/*') ) active  @endif" >
              {!! trans("public.about") !!}
          </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
          <div class="dropdown">
              <a class="btn  dropdown-toggle nav-color {{ (request()->is('issues/*')) ? 'active ' : '' }}" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                 aria-haspopup="true" aria-expanded="false" >
                  القضايا
              </a>
              <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuLink">

                      <a class="dropdown-item" href="/issues/one">{{ trans('public.DEATHPENALTY') }}</a>
      ...
      <li class="nav-item ">
        ...
        <a  href="/ourworks" class="nav-link nav-color @if(\Request::is('ourworks*') ) active  @endif">
            {{ trans('public.ourwork') }}
        </a>
    </li>
    <li class="nav-item">
        <div class="dropdown">
            <a class="btn  dropdown-toggle nav-color {{ (request()->is('images*')) ||  (request()->is('videos*'))  ? 'active ' : '' }}" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false" >
               المعرض 
            </a>
            <div class="dropdown-menu text-center " aria-labelledby="dropdownMenuLink" >

                    <a class="dropdown-item @if(\Request::is('images*') ) active  @endif" href="/images">{{ trans('public.images') }}</a>

                    <a class="dropdown-item @if(\Request::is('videos*') ) active  @endif" href="/videos">{{ trans('public.videos') }}</a>
            </div>
        </div>
      </li>
      <li class="nav-item "><a href="{{'/mails/create' }}"  class="nav-link nav-color {{ (request()->is('mails*')) ? 'active' : '' }} ">{!! trans("public.contactus")!!}</a></li>
      <li class="nav-item"><button type="button" class="btn btn-web">أبلغ عن</button></li>
      <li class="nav-item">
        <div class="dropdown">
            <a class="btn  dropdown nav-color {{ (request()->is('issues/*')) ? 'active ' : '' }}" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false" >
