...
<div class="container">
    <div class="row">
        <!-- default start -->
        <div class="product-slider col-sm-4">
            <!-- /thumbcarousel -->
        ...
        <div class="col-sm-4">
            <div class="col-sm-12">
                <div class="main-head">
                        <div class="col-sm-12 text-right">
                                ...
                                <h3 class="main-headline sub_colored"><b>{{$product->name}}</b></h3>
                    ...
                    <div class="row">
                        <div class="share-social-icons" >
                            <ul class="share-icons">
                                ...
                                <li>
                                    <a target="_blank" href="https://plus.google.com/share?url={!! Request::url() !!} {!! $product->name !!} {!! settings("websiteName") !!}" class="social-icon"> <i class="icon-instagram1"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="share-icons-mobile hidden-lg hidden-md divide-xs" role="navigation" style="">
                    <h3 style="margin-right: 17px;">{{ trans('public.shareProduct') }}</h3>
    ...
    <div class="divide-md">
        ...
        @foreach($more as  $key =>  $product)
            <div class="col-sm-3 divide-sm parent">
