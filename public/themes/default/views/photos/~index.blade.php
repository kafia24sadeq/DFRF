...
@section('title' , $photos[0]->videoCategory->name )
{{-- @section('breadcrumbs', Breadcrumbs::render('posts', $post )) --}}
@section('pageheading', $photos[0]->videoCategory->name)



{{--{!! MetaTags( $photos[0]->videoCategory->name, excerptHelper(settings("metaDescription"),150,''),ThemeHelper()."img/logo.png" , settings("metaKeywors") , settings("websiteName") ) !!}--}}


@section('content')

  <div class="page-header">
     <h1>{!! $photos[0]->videoCategory->name !!}</h1>
  </div>
