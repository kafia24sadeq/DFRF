...
//      dd($options);
        return view('admin.polls.show', compact('model' , 'options' ));
    }
...
//
//
//            $page =  PollOption::where('poll_id', $page->id)->find($id);
//            $field_presenter = 'option'.$i;
//            $data = ['name'=> $request->$field_presenter ] ;
//
//            $page->update($data);
//        }
//
